// ==============================================================
// File generated on Sun Mar 28 22:08:16 -0600 2021
...
volatile float Imag[16384])
{
	...
	if (wrapc_switch_file_token.good())
	{
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			sc_bv<32> *Real_0_pc_buffer = new sc_bv<32>[4096];
			int i = 0;
			...
			if (i > 0)
			{
				// RTL Name: Real_0
				{
					...
					// {
						// celement: Real(31, 0)
						// {
							sc_lv<32>* Real_lv0_0_16380_4 = new sc_lv<32>[4096];
						// }
					// }
					...
					// bitslice(31, 0)
					{
						...
						{
							// carray: (0) => (16380) @ (4)
							for (int i_0 = 0; i_0 <= 16380; i_0 += 4)
							{
								if (&(Real[0]) != NULL) // check the null address if the c port is array or others
								{
									Real_lv0_0_16380_4[hls_map_index].range(31, 0) = sc_bv<32>(Real_0_pc_buffer[hls_map_index].range(31, 0));
									hls_map_index++;
								}
							}
						}
					...
					// bitslice(31, 0)
					{
						...
						// celement: Real(31, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 16380; i_0 += 4)
							{
								...
								// output_type_conversion : (Real_lv0_0_16380_4[hls_map_index]).to_uint64()
								if (&(Real[0]) != NULL) // check the null address if the c port is array or others
								{
									*(int*)&Real[i_0] = (Real_lv0_0_16380_4[hls_map_index]).to_uint64();
									hls_map_index++;
								}
							}
						}
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			sc_bv<32> *Real_1_pc_buffer = new sc_bv<32>[4096];
			int i = 0;
			...
			if (i > 0)
			{
				// RTL Name: Real_1
				{
					...
					// {
						// celement: Real(31, 0)
						// {
							sc_lv<32>* Real_lv0_1_16381_4 = new sc_lv<32>[4096];
						// }
					// }
					...
					// bitslice(31, 0)
					{
						...
						{
							// carray: (1) => (16381) @ (4)
							for (int i_0 = 1; i_0 <= 16381; i_0 += 4)
							{
								if (&(Real[0]) != NULL) // check the null address if the c port is array or others
								{
									Real_lv0_1_16381_4[hls_map_index].range(31, 0) = sc_bv<32>(Real_1_pc_buffer[hls_map_index].range(31, 0));
									hls_map_index++;
								}
							}
						}
					...
					// bitslice(31, 0)
					{
						...
						// celement: Real(31, 0)
						{
							...
							for (int i_0 = 1; i_0 <= 16381; i_0 += 4)
							{
								...
								// ori_name_1st_elem      : Real[0]
								// output_left_conversion : *(int*)&Real[i_0]
								// output_type_conversion : (Real_lv0_1_16381_4[hls_map_index]).to_uint64()
								if (&(Real[0]) != NULL) // check the null address if the c port is array or others
								{
									*(int*)&Real[i_0] = (Real_lv0_1_16381_4[hls_map_index]).to_uint64();
									hls_map_index++;
								}
							}
						}
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			sc_bv<32> *Real_2_pc_buffer = new sc_bv<32>[4096];
			int i = 0;
			...
			if (i > 0)
			{
				// RTL Name: Real_2
				{
					...
					// {
						// celement: Real(31, 0)
						// {
							sc_lv<32>* Real_lv0_2_16382_4 = new sc_lv<32>[4096];
						// }
					// }
					...
					// bitslice(31, 0)
					{
						...
						{
							// carray: (2) => (16382) @ (4)
							for (int i_0 = 2; i_0 <= 16382; i_0 += 4)
							{
								if (&(Real[0]) != NULL) // check the null address if the c port is array or others
								{
									Real_lv0_2_16382_4[hls_map_index].range(31, 0) = sc_bv<32>(Real_2_pc_buffer[hls_map_index].range(31, 0));
									hls_map_index++;
								}
							}
						}
					...
					// bitslice(31, 0)
					{
						...
						// celement: Real(31, 0)
						{
							...
							for (int i_0 = 2; i_0 <= 16382; i_0 += 4)
							{
								...
								// ori_name_1st_elem      : Real[0]
								// output_left_conversion : *(int*)&Real[i_0]
								// output_type_conversion : (Real_lv0_2_16382_4[hls_map_index]).to_uint64()
								if (&(Real[0]) != NULL) // check the null address if the c port is array or others
								{
									*(int*)&Real[i_0] = (Real_lv0_2_16382_4[hls_map_index]).to_uint64();
									hls_map_index++;
								}
							}
						}
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			sc_bv<32> *Real_3_pc_buffer = new sc_bv<32>[4096];
			int i = 0;
			...
			if (i > 0)
			{
				// RTL Name: Real_3
				{
					...
					// {
						// celement: Real(31, 0)
						// {
							sc_lv<32>* Real_lv0_3_16383_4 = new sc_lv<32>[4096];
						// }
					// }
					...
					// bitslice(31, 0)
					{
						...
						{
							// carray: (3) => (16383) @ (4)
							for (int i_0 = 3; i_0 <= 16383; i_0 += 4)
							{
								if (&(Real[0]) != NULL) // check the null address if the c port is array or others
								{
									Real_lv0_3_16383_4[hls_map_index].range(31, 0) = sc_bv<32>(Real_3_pc_buffer[hls_map_index].range(31, 0));
									hls_map_index++;
								}
							}
						}
					...
					// bitslice(31, 0)
					{
						...
						// celement: Real(31, 0)
						{
							...
							for (int i_0 = 3; i_0 <= 16383; i_0 += 4)
							{
								...
								// ori_name_1st_elem      : Real[0]
								// output_left_conversion : *(int*)&Real[i_0]
								// output_type_conversion : (Real_lv0_3_16383_4[hls_map_index]).to_uint64()
								if (&(Real[0]) != NULL) // check the null address if the c port is array or others
								{
									*(int*)&Real[i_0] = (Real_lv0_3_16383_4[hls_map_index]).to_uint64();
									hls_map_index++;
								}
							}
						}
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			sc_bv<32> *Imag_0_pc_buffer = new sc_bv<32>[4096];
			int i = 0;
			...
			if (i > 0)
			{
				// RTL Name: Imag_0
				{
					...
					// {
						// celement: Imag(31, 0)
						// {
							sc_lv<32>* Imag_lv0_0_16380_4 = new sc_lv<32>[4096];
						// }
					// }
					...
					// bitslice(31, 0)
					{
						...
						// celement: Imag(31, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 16380; i_0 += 4)
							{
								...
								{
									Imag_lv0_0_16380_4[hls_map_index].range(31, 0) = sc_bv<32>(Imag_0_pc_buffer[hls_map_index].range(31, 0));
									hls_map_index++;
								}
							}
						}
					...
					// bitslice(31, 0)
					{
						...
						// celement: Imag(31, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 16380; i_0 += 4)
							{
								...
								// output_type_conversion : (Imag_lv0_0_16380_4[hls_map_index]).to_uint64()
								if (&(Imag[0]) != NULL) // check the null address if the c port is array or others
								{
									*(int*)&Imag[i_0] = (Imag_lv0_0_16380_4[hls_map_index]).to_uint64();
									hls_map_index++;
								}
							}
						}
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			sc_bv<32> *Imag_1_pc_buffer = new sc_bv<32>[4096];
			int i = 0;
			...
			if (i > 0)
			{
				// RTL Name: Imag_1
				{
					...
					// {
						// celement: Imag(31, 0)
						// {
							sc_lv<32>* Imag_lv0_1_16381_4 = new sc_lv<32>[4096];
						// }
					// }
					...
					// bitslice(31, 0)
					{
						...
						// celement: Imag(31, 0)
						{
							...
							for (int i_0 = 1; i_0 <= 16381; i_0 += 4)
							{
								if (&(Imag[0]) != NULL) // check the null address if the c port is array or others
								{
									Imag_lv0_1_16381_4[hls_map_index].range(31, 0) = sc_bv<32>(Imag_1_pc_buffer[hls_map_index].range(31, 0));
									hls_map_index++;
								}
							}
						}
					...
					// bitslice(31, 0)
					{
						...
						// celement: Imag(31, 0)
						{
							...
							for (int i_0 = 1; i_0 <= 16381; i_0 += 4)
							{
								...
								// ori_name_1st_elem      : Imag[0]
								// output_left_conversion : *(int*)&Imag[i_0]
								// output_type_conversion : (Imag_lv0_1_16381_4[hls_map_index]).to_uint64()
								if (&(Imag[0]) != NULL) // check the null address if the c port is array or others
								{
									*(int*)&Imag[i_0] = (Imag_lv0_1_16381_4[hls_map_index]).to_uint64();
									hls_map_index++;
								}
							}
						}
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			sc_bv<32> *Imag_2_pc_buffer = new sc_bv<32>[4096];
			int i = 0;
			...
			if (i > 0)
			{
				// RTL Name: Imag_2
				{
					...
					// {
						// celement: Imag(31, 0)
						// {
							sc_lv<32>* Imag_lv0_2_16382_4 = new sc_lv<32>[4096];
						// }
					// }
					...
					// bitslice(31, 0)
					{
						...
						// celement: Imag(31, 0)
						{
							...
							for (int i_0 = 2; i_0 <= 16382; i_0 += 4)
							{
								if (&(Imag[0]) != NULL) // check the null address if the c port is array or others
								{
									Imag_lv0_2_16382_4[hls_map_index].range(31, 0) = sc_bv<32>(Imag_2_pc_buffer[hls_map_index].range(31, 0));
									hls_map_index++;
								}
							}
						}
					...
					// bitslice(31, 0)
					{
						...
						// celement: Imag(31, 0)
						{
							...
							for (int i_0 = 2; i_0 <= 16382; i_0 += 4)
							{
								...
								// ori_name_1st_elem      : Imag[0]
								// output_left_conversion : *(int*)&Imag[i_0]
								// output_type_conversion : (Imag_lv0_2_16382_4[hls_map_index]).to_uint64()
								if (&(Imag[0]) != NULL) // check the null address if the c port is array or others
								{
									*(int*)&Imag[i_0] = (Imag_lv0_2_16382_4[hls_map_index]).to_uint64();
									hls_map_index++;
								}
							}
						}
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			sc_bv<32> *Imag_3_pc_buffer = new sc_bv<32>[4096];
			int i = 0;
			...
			if (i > 0)
			{
				// RTL Name: Imag_3
				{
					...
					// {
						// celement: Imag(31, 0)
						// {
							sc_lv<32>* Imag_lv0_3_16383_4 = new sc_lv<32>[4096];
						// }
					// }
					...
					// bitslice(31, 0)
					{
						...
						// celement: Imag(31, 0)
						{
							...
							for (int i_0 = 3; i_0 <= 16383; i_0 += 4)
							{
								if (&(Imag[0]) != NULL) // check the null address if the c port is array or others
								{
									Imag_lv0_3_16383_4[hls_map_index].range(31, 0) = sc_bv<32>(Imag_3_pc_buffer[hls_map_index].range(31, 0));
									hls_map_index++;
								}
							}
						}
					...
					// bitslice(31, 0)
					{
						...
						// celement: Imag(31, 0)
						{
							...
							for (int i_0 = 3; i_0 <= 16383; i_0 += 4)
							{
								...
								// ori_name_1st_elem      : Imag[0]
								// output_left_conversion : *(int*)&Imag[i_0]
								// output_type_conversion : (Imag_lv0_3_16383_4[hls_map_index]).to_uint64()
								if (&(Imag[0]) != NULL) // check the null address if the c port is array or others
								{
									*(int*)&Imag[i_0] = (Imag_lv0_3_16383_4[hls_map_index]).to_uint64();
									hls_map_index++;
								}
							}
						}
	...
	else
	{
		...
		sc_bv<32>* Real_0_tvin_wrapc_buffer = new sc_bv<32>[4096];
		...
		tcl_file.set_num(4096, &tcl_file.Real_0_depth);
		...
		sc_bv<32>* Real_1_tvin_wrapc_buffer = new sc_bv<32>[4096];
		...
		tcl_file.set_num(4096, &tcl_file.Real_1_depth);
		...
		sc_bv<32>* Real_2_tvin_wrapc_buffer = new sc_bv<32>[4096];
		...
		tcl_file.set_num(4096, &tcl_file.Real_2_depth);
		...
		sc_bv<32>* Real_3_tvin_wrapc_buffer = new sc_bv<32>[4096];
		...
		tcl_file.set_num(4096, &tcl_file.Real_3_depth);
		...
		sc_bv<32>* Imag_0_tvin_wrapc_buffer = new sc_bv<32>[4096];
		...
		tcl_file.set_num(4096, &tcl_file.Imag_0_depth);
		...
		sc_bv<32>* Imag_1_tvin_wrapc_buffer = new sc_bv<32>[4096];
		...
		tcl_file.set_num(4096, &tcl_file.Imag_1_depth);
		...
		sc_bv<32>* Imag_2_tvin_wrapc_buffer = new sc_bv<32>[4096];
		...
		tcl_file.set_num(4096, &tcl_file.Imag_2_depth);
		...
		sc_bv<32>* Imag_3_tvin_wrapc_buffer = new sc_bv<32>[4096];
		...
		tcl_file.set_num(4096, &tcl_file.Imag_3_depth);
...
// [call_c_dut] ---------->
		...
		sc_bv<32>* Real_0_tvout_wrapc_buffer = new sc_bv<32>[4096];
		...
		sc_bv<32>* Real_1_tvout_wrapc_buffer = new sc_bv<32>[4096];
		...
		sc_bv<32>* Real_2_tvout_wrapc_buffer = new sc_bv<32>[4096];
		...
		sc_bv<32>* Real_3_tvout_wrapc_buffer = new sc_bv<32>[4096];
		...
		sc_bv<32>* Imag_0_tvout_wrapc_buffer = new sc_bv<32>[4096];
		...
		sc_bv<32>* Imag_1_tvout_wrapc_buffer = new sc_bv<32>[4096];
		...
		sc_bv<32>* Imag_2_tvout_wrapc_buffer = new sc_bv<32>[4096];
		...
		sc_bv<32>* Imag_3_tvout_wrapc_buffer = new sc_bv<32>[4096];
