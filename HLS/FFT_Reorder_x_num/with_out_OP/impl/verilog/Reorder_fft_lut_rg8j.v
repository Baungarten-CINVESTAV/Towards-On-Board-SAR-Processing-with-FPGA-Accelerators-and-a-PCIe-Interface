...
// ==============================================================
`timescale 1 ns / 1 ps
module Reorder_fft_lut_rg8j_rom (
addr0, ce0, q0, clk);
...
initial begin
    $readmemh("./Reorder_fft_lut_rg8j_rom.dat", ram);
end
...
Reorder_fft_lut_rg8j_rom Reorder_fft_lut_rg8j_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ));
