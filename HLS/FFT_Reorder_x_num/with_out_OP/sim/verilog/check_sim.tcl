...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         ...
         "c.Reorder_fft.autotvin_Real_r.dat"
         "c.Reorder_fft.autotvin_Imag.dat"
         "c.Reorder_fft.autotvout_Real_r.dat"
         "c.Reorder_fft.autotvout_Imag.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.Reorder_fft.autotvout_Real_r.dat"
         "rtl.Reorder_fft.autotvout_Imag.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
