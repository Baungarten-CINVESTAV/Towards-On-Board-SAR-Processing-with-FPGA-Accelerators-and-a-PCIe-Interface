# ==============================================================
# File generated on Sun Mar 28 22:24:42 -0600 2021
...
if {[file isfile Reorder_fft.autotvin.dat]} {
	file delete -force Reorder_fft.autotvin.dat
}

if {[file isfile Reorder_fft.autotvout.dat]} {
	file delete -force Reorder_fft.autotvout.dat
}
