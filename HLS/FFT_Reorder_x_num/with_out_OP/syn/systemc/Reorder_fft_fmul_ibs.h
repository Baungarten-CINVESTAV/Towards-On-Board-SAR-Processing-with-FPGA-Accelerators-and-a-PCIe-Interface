...
// ==============================================================
#ifndef __Reorder_fft_fmul_ibs__HH__
#define __Reorder_fft_fmul_ibs__HH__
#include "ACMP_fmul.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Reorder_fft_fmul_ibs) {
    ...
    SC_CTOR(Reorder_fft_fmul_ibs):  ACMP_fmul_U ("ACMP_fmul_U") {
        ACMP_fmul_U.clk(clk);
