...
`define AUTOTB_TVIN_Real_0  "./c.Reorder_fft.autotvin_Real_0.dat"
`define AUTOTB_TVIN_Real_1  "./c.Reorder_fft.autotvin_Real_1.dat"
`define AUTOTB_TVIN_Real_2  "./c.Reorder_fft.autotvin_Real_2.dat"
`define AUTOTB_TVIN_Real_3  "./c.Reorder_fft.autotvin_Real_3.dat"
`define AUTOTB_TVIN_Imag_0  "./c.Reorder_fft.autotvin_Imag_0.dat"
`define AUTOTB_TVIN_Imag_1  "./c.Reorder_fft.autotvin_Imag_1.dat"
`define AUTOTB_TVIN_Imag_2  "./c.Reorder_fft.autotvin_Imag_2.dat"
`define AUTOTB_TVIN_Imag_3  "./c.Reorder_fft.autotvin_Imag_3.dat"
`define AUTOTB_TVIN_Real_0_out_wrapc  "./rtl.Reorder_fft.autotvin_Real_0.dat"
`define AUTOTB_TVIN_Real_1_out_wrapc  "./rtl.Reorder_fft.autotvin_Real_1.dat"
`define AUTOTB_TVIN_Real_2_out_wrapc  "./rtl.Reorder_fft.autotvin_Real_2.dat"
`define AUTOTB_TVIN_Real_3_out_wrapc  "./rtl.Reorder_fft.autotvin_Real_3.dat"
`define AUTOTB_TVIN_Imag_0_out_wrapc  "./rtl.Reorder_fft.autotvin_Imag_0.dat"
`define AUTOTB_TVIN_Imag_1_out_wrapc  "./rtl.Reorder_fft.autotvin_Imag_1.dat"
`define AUTOTB_TVIN_Imag_2_out_wrapc  "./rtl.Reorder_fft.autotvin_Imag_2.dat"
`define AUTOTB_TVIN_Imag_3_out_wrapc  "./rtl.Reorder_fft.autotvin_Imag_3.dat"
`define AUTOTB_TVOUT_Real_0  "./c.Reorder_fft.autotvout_Real_0.dat"
`define AUTOTB_TVOUT_Real_1  "./c.Reorder_fft.autotvout_Real_1.dat"
`define AUTOTB_TVOUT_Real_2  "./c.Reorder_fft.autotvout_Real_2.dat"
`define AUTOTB_TVOUT_Real_3  "./c.Reorder_fft.autotvout_Real_3.dat"
`define AUTOTB_TVOUT_Imag_0  "./c.Reorder_fft.autotvout_Imag_0.dat"
`define AUTOTB_TVOUT_Imag_1  "./c.Reorder_fft.autotvout_Imag_1.dat"
`define AUTOTB_TVOUT_Imag_2  "./c.Reorder_fft.autotvout_Imag_2.dat"
`define AUTOTB_TVOUT_Imag_3  "./c.Reorder_fft.autotvout_Imag_3.dat"
`define AUTOTB_TVOUT_Real_0_out_wrapc  "./impl_rtl.Reorder_fft.autotvout_Real_0.dat"
`define AUTOTB_TVOUT_Real_1_out_wrapc  "./impl_rtl.Reorder_fft.autotvout_Real_1.dat"
`define AUTOTB_TVOUT_Real_2_out_wrapc  "./impl_rtl.Reorder_fft.autotvout_Real_2.dat"
`define AUTOTB_TVOUT_Real_3_out_wrapc  "./impl_rtl.Reorder_fft.autotvout_Real_3.dat"
`define AUTOTB_TVOUT_Imag_0_out_wrapc  "./impl_rtl.Reorder_fft.autotvout_Imag_0.dat"
`define AUTOTB_TVOUT_Imag_1_out_wrapc  "./impl_rtl.Reorder_fft.autotvout_Imag_1.dat"
`define AUTOTB_TVOUT_Imag_2_out_wrapc  "./impl_rtl.Reorder_fft.autotvout_Imag_2.dat"
`define AUTOTB_TVOUT_Imag_3_out_wrapc  "./impl_rtl.Reorder_fft.autotvout_Imag_3.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 2703;
parameter LENGTH_Real_0 = 256;
parameter LENGTH_Real_1 = 256;
parameter LENGTH_Real_2 = 256;
parameter LENGTH_Real_3 = 256;
parameter LENGTH_Imag_0 = 256;
parameter LENGTH_Imag_1 = 256;
parameter LENGTH_Imag_2 = 256;
parameter LENGTH_Imag_3 = 256;
...
wire    [7 : 0]    arrayReal_0_address0, arrayReal_0_address1;
...
wire    [7 : 0]    arrayReal_1_address0, arrayReal_1_address1;
...
wire    [7 : 0]    arrayReal_2_address0, arrayReal_2_address1;
...
wire    [7 : 0]    arrayReal_3_address0, arrayReal_3_address1;
...
wire    [7 : 0]    arrayImag_0_address0, arrayImag_0_address1;
...
wire    [7 : 0]    arrayImag_1_address0, arrayImag_1_address1;
...
wire    [7 : 0]    arrayImag_2_address0, arrayImag_2_address1;
...
wire    [7 : 0]    arrayImag_3_address0, arrayImag_3_address1;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.Reorder_fft.autotvout_Real_0.dat", "r");
    fp2 = $fopen("./impl_rtl.Reorder_fft.autotvout_Real_0.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.Reorder_fft.autotvout_Real_0.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.Reorder_fft.autotvout_Real_0.dat\"!");
    else begin
        $display("Comparing rtl.Reorder_fft.autotvout_Real_0.dat with impl_rtl.Reorder_fft.autotvout_Real_0.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.Reorder_fft.autotvout_Real_1.dat", "r");
    fp2 = $fopen("./impl_rtl.Reorder_fft.autotvout_Real_1.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.Reorder_fft.autotvout_Real_1.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.Reorder_fft.autotvout_Real_1.dat\"!");
    else begin
        $display("Comparing rtl.Reorder_fft.autotvout_Real_1.dat with impl_rtl.Reorder_fft.autotvout_Real_1.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.Reorder_fft.autotvout_Real_2.dat", "r");
    fp2 = $fopen("./impl_rtl.Reorder_fft.autotvout_Real_2.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.Reorder_fft.autotvout_Real_2.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.Reorder_fft.autotvout_Real_2.dat\"!");
    else begin
        $display("Comparing rtl.Reorder_fft.autotvout_Real_2.dat with impl_rtl.Reorder_fft.autotvout_Real_2.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.Reorder_fft.autotvout_Real_3.dat", "r");
    fp2 = $fopen("./impl_rtl.Reorder_fft.autotvout_Real_3.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.Reorder_fft.autotvout_Real_3.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.Reorder_fft.autotvout_Real_3.dat\"!");
    else begin
        $display("Comparing rtl.Reorder_fft.autotvout_Real_3.dat with impl_rtl.Reorder_fft.autotvout_Real_3.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.Reorder_fft.autotvout_Imag_0.dat", "r");
    fp2 = $fopen("./impl_rtl.Reorder_fft.autotvout_Imag_0.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.Reorder_fft.autotvout_Imag_0.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.Reorder_fft.autotvout_Imag_0.dat\"!");
    else begin
        $display("Comparing rtl.Reorder_fft.autotvout_Imag_0.dat with impl_rtl.Reorder_fft.autotvout_Imag_0.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.Reorder_fft.autotvout_Imag_1.dat", "r");
    fp2 = $fopen("./impl_rtl.Reorder_fft.autotvout_Imag_1.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.Reorder_fft.autotvout_Imag_1.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.Reorder_fft.autotvout_Imag_1.dat\"!");
    else begin
        $display("Comparing rtl.Reorder_fft.autotvout_Imag_1.dat with impl_rtl.Reorder_fft.autotvout_Imag_1.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.Reorder_fft.autotvout_Imag_2.dat", "r");
    fp2 = $fopen("./impl_rtl.Reorder_fft.autotvout_Imag_2.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.Reorder_fft.autotvout_Imag_2.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.Reorder_fft.autotvout_Imag_2.dat\"!");
    else begin
        $display("Comparing rtl.Reorder_fft.autotvout_Imag_2.dat with impl_rtl.Reorder_fft.autotvout_Imag_2.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.Reorder_fft.autotvout_Imag_3.dat", "r");
    fp2 = $fopen("./impl_rtl.Reorder_fft.autotvout_Imag_3.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.Reorder_fft.autotvout_Imag_3.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.Reorder_fft.autotvout_Imag_3.dat\"!");
    else begin
        $display("Comparing rtl.Reorder_fft.autotvout_Imag_3.dat with impl_rtl.Reorder_fft.autotvout_Imag_3.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
