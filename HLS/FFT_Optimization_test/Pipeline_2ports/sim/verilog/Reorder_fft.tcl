...
add_wave /apatb_Reorder_fft_top/AESL_inst_Reorder_fft/Imag_Rst_B -into $Imag_group -radix hex
add_wave /apatb_Reorder_fft_top/AESL_inst_Reorder_fft/Imag_Clk_B -into $Imag_group -radix hex
add_wave /apatb_Reorder_fft_top/AESL_inst_Reorder_fft/Imag_Dout_B -into $Imag_group -radix hex
add_wave /apatb_Reorder_fft_top/AESL_inst_Reorder_fft/Imag_Din_B -into $Imag_group -radix hex
add_wave /apatb_Reorder_fft_top/AESL_inst_Reorder_fft/Imag_WEN_B -into $Imag_group -color #ffff00 -radix hex
add_wave /apatb_Reorder_fft_top/AESL_inst_Reorder_fft/Imag_EN_B -into $Imag_group -color #ffff00 -radix hex
add_wave /apatb_Reorder_fft_top/AESL_inst_Reorder_fft/Imag_Addr_B -into $Imag_group -radix hex
...
add_wave /apatb_Reorder_fft_top/AESL_inst_Reorder_fft/Real_r_Rst_B -into $Real_group -radix hex
add_wave /apatb_Reorder_fft_top/AESL_inst_Reorder_fft/Real_r_Clk_B -into $Real_group -radix hex
add_wave /apatb_Reorder_fft_top/AESL_inst_Reorder_fft/Real_r_Dout_B -into $Real_group -radix hex
add_wave /apatb_Reorder_fft_top/AESL_inst_Reorder_fft/Real_r_Din_B -into $Real_group -radix hex
add_wave /apatb_Reorder_fft_top/AESL_inst_Reorder_fft/Real_r_WEN_B -into $Real_group -color #ffff00 -radix hex
add_wave /apatb_Reorder_fft_top/AESL_inst_Reorder_fft/Real_r_EN_B -into $Real_group -color #ffff00 -radix hex
add_wave /apatb_Reorder_fft_top/AESL_inst_Reorder_fft/Real_r_Addr_B -into $Real_group -radix hex
...
add_wave /apatb_Reorder_fft_top/Imag_RST_B -into $tb_Imag_group -radix hex
add_wave /apatb_Reorder_fft_top/Imag_CLK_B -into $tb_Imag_group -radix hex
add_wave /apatb_Reorder_fft_top/Imag_DOUT_B -into $tb_Imag_group -radix hex
add_wave /apatb_Reorder_fft_top/Imag_DIN_B -into $tb_Imag_group -radix hex
add_wave /apatb_Reorder_fft_top/Imag_WEN_B -into $tb_Imag_group -color #ffff00 -radix hex
add_wave /apatb_Reorder_fft_top/Imag_EN_B -into $tb_Imag_group -color #ffff00 -radix hex
add_wave /apatb_Reorder_fft_top/Imag_ADDR_B -into $tb_Imag_group -radix hex
...
add_wave /apatb_Reorder_fft_top/Real_r_RST_B -into $tb_Real_group -radix hex
add_wave /apatb_Reorder_fft_top/Real_r_CLK_B -into $tb_Real_group -radix hex
add_wave /apatb_Reorder_fft_top/Real_r_DOUT_B -into $tb_Real_group -radix hex
add_wave /apatb_Reorder_fft_top/Real_r_DIN_B -into $tb_Real_group -radix hex
add_wave /apatb_Reorder_fft_top/Real_r_WEN_B -into $tb_Real_group -color #ffff00 -radix hex
add_wave /apatb_Reorder_fft_top/Real_r_EN_B -into $tb_Real_group -color #ffff00 -radix hex
add_wave /apatb_Reorder_fft_top/Real_r_ADDR_B -into $tb_Real_group -radix hex
