...
set C_modelArgList {
	{ Real_r float 32 regular {bram 1024 { 2 2 } 1 1 }  }
	{ Imag float 32 regular {bram 1024 { 2 2 } 1 1 }  }
}
...
set portList { 
	...
	{ Real_r_Addr_B sc_out sc_lv 32 signal 0 } 
	{ Real_r_EN_B sc_out sc_logic 1 signal 0 } 
	{ Real_r_WEN_B sc_out sc_lv 4 signal 0 } 
	{ Real_r_Din_B sc_out sc_lv 32 signal 0 } 
	{ Real_r_Dout_B sc_in sc_lv 32 signal 0 } 
	{ Real_r_Clk_B sc_out sc_logic 1 signal 0 } 
	{ Real_r_Rst_B sc_out sc_logic 1 signal 0 } 
	...
	{ Imag_Addr_B sc_out sc_lv 32 signal 1 } 
	{ Imag_EN_B sc_out sc_logic 1 signal 1 } 
	{ Imag_WEN_B sc_out sc_lv 4 signal 1 } 
	{ Imag_Din_B sc_out sc_lv 32 signal 1 } 
	{ Imag_Dout_B sc_in sc_lv 32 signal 1 } 
	{ Imag_Clk_B sc_out sc_logic 1 signal 1 } 
	{ Imag_Rst_B sc_out sc_logic 1 signal 1 } 
...
set NewPortList {[ 
	...
	{ "name": "interrupt", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "AXILiteS", "role": "interrupt" } }, 
 	...
 	{ "name": "Real_r_Addr_B", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "Real_r", "role": "Addr_B" }} , 
 	{ "name": "Real_r_EN_B", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "Real_r", "role": "EN_B" }} , 
 	{ "name": "Real_r_WEN_B", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "Real_r", "role": "WEN_B" }} , 
 	{ "name": "Real_r_Din_B", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "Real_r", "role": "Din_B" }} , 
 	{ "name": "Real_r_Dout_B", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "Real_r", "role": "Dout_B" }} , 
 	{ "name": "Real_r_Clk_B", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "Real_r", "role": "Clk_B" }} , 
 	{ "name": "Real_r_Rst_B", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "Real_r", "role": "Rst_B" }} , 
 	...
 	{ "name": "Imag_Addr_B", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "Imag", "role": "Addr_B" }} , 
 	{ "name": "Imag_EN_B", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "Imag", "role": "EN_B" }} , 
 	{ "name": "Imag_WEN_B", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "Imag", "role": "WEN_B" }} , 
 	{ "name": "Imag_Din_B", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "Imag", "role": "Din_B" }} , 
 	{ "name": "Imag_Dout_B", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "Imag", "role": "Dout_B" }} , 
 	{ "name": "Imag_Clk_B", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "Imag", "role": "Clk_B" }} , 
 	{ "name": "Imag_Rst_B", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "Imag", "role": "Rst_B" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6", "7"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "2738", "EstimateLatencyMax" : "2738",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
...
set ArgLastReadFirstWriteLatency {
	Reorder_fft {
		Real_r {Type IO LastRead 5 FirstWrite 5}
		Imag {Type IO LastRead 5 FirstWrite 5}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2738", "Max" : "2738"}
	, {"Name" : "Interval", "Min" : "2739", "Max" : "2739"}
]}
...
set Spec2ImplPortList { 
	Real_r { bram {  { Real_r_Addr_A MemPortADDR2 1 32 }  { Real_r_EN_A MemPortCE2 1 1 }  { Real_r_WEN_A MemPortWE2 1 4 }  { Real_r_Din_A MemPortDIN2 1 32 }  { Real_r_Dout_A MemPortDOUT2 0 32 }  { Real_r_Clk_A mem_clk 1 1 }  { Real_r_Rst_A mem_rst 1 1 }  { Real_r_Addr_B MemPortADDR2 1 32 }  { Real_r_EN_B MemPortCE2 1 1 }  { Real_r_WEN_B MemPortWE2 1 4 }  { Real_r_Din_B MemPortDIN2 1 32 }  { Real_r_Dout_B MemPortDOUT2 0 32 }  { Real_r_Clk_B mem_clk 1 1 }  { Real_r_Rst_B mem_rst 1 1 } } }
	Imag { bram {  { Imag_Addr_A MemPortADDR2 1 32 }  { Imag_EN_A MemPortCE2 1 1 }  { Imag_WEN_A MemPortWE2 1 4 }  { Imag_Din_A MemPortDIN2 1 32 }  { Imag_Dout_A MemPortDOUT2 0 32 }  { Imag_Clk_A mem_clk 1 1 }  { Imag_Rst_A mem_rst 1 1 }  { Imag_Addr_B MemPortADDR2 1 32 }  { Imag_EN_B MemPortCE2 1 1 }  { Imag_WEN_B MemPortWE2 1 4 }  { Imag_Din_B MemPortDIN2 1 32 }  { Imag_Dout_B MemPortDOUT2 0 32 }  { Imag_Clk_B mem_clk 1 1 }  { Imag_Rst_B mem_rst 1 1 } } }
}
