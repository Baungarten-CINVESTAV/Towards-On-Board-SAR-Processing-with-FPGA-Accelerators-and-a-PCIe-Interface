...
module bd_0
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:bram:1.0 Imag_PORTB " *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME Imag_PORTB, MASTER_TYPE BRAM_CTRL, MEM_ECC NONE, MEM_SIZE 4, MEM_WIDTH 32, READ_LATENCY 1" *) output [31:0]Imag_PORTB_addr;
  (* X_INTERFACE_INFO = "xilinx.com:interface:bram:1.0 Imag_PORTB " *) output Imag_PORTB_clk;
  (* X_INTERFACE_INFO = "xilinx.com:interface:bram:1.0 Imag_PORTB " *) output [31:0]Imag_PORTB_din;
  (* X_INTERFACE_INFO = "xilinx.com:interface:bram:1.0 Imag_PORTB " *) input [31:0]Imag_PORTB_dout;
  (* X_INTERFACE_INFO = "xilinx.com:interface:bram:1.0 Imag_PORTB " *) output Imag_PORTB_en;
  (* X_INTERFACE_INFO = "xilinx.com:interface:bram:1.0 Imag_PORTB " *) output Imag_PORTB_rst;
  (* X_INTERFACE_INFO = "xilinx.com:interface:bram:1.0 Imag_PORTB " *) output [3:0]Imag_PORTB_we;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:bram:1.0 Real_r_PORTB " *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME Real_r_PORTB, MASTER_TYPE BRAM_CTRL, MEM_ECC NONE, MEM_SIZE 4, MEM_WIDTH 32, READ_LATENCY 1" *) output [31:0]Real_r_PORTB_addr;
  (* X_INTERFACE_INFO = "xilinx.com:interface:bram:1.0 Real_r_PORTB " *) output Real_r_PORTB_clk;
  (* X_INTERFACE_INFO = "xilinx.com:interface:bram:1.0 Real_r_PORTB " *) output [31:0]Real_r_PORTB_din;
  (* X_INTERFACE_INFO = "xilinx.com:interface:bram:1.0 Real_r_PORTB " *) input [31:0]Real_r_PORTB_dout;
  (* X_INTERFACE_INFO = "xilinx.com:interface:bram:1.0 Real_r_PORTB " *) output Real_r_PORTB_en;
  (* X_INTERFACE_INFO = "xilinx.com:interface:bram:1.0 Real_r_PORTB " *) output Real_r_PORTB_rst;
  (* X_INTERFACE_INFO = "xilinx.com:interface:bram:1.0 Real_r_PORTB " *) output [3:0]Real_r_PORTB_we;
  ...
  wire [31:0]hls_inst_Imag_PORTB_ADDR;
  wire hls_inst_Imag_PORTB_CLK;
  wire [31:0]hls_inst_Imag_PORTB_DIN;
  wire [31:0]hls_inst_Imag_PORTB_DOUT;
  wire hls_inst_Imag_PORTB_EN;
  wire hls_inst_Imag_PORTB_RST;
  wire [3:0]hls_inst_Imag_PORTB_WE;
  ...
  wire [31:0]hls_inst_Real_r_PORTB_ADDR;
  wire hls_inst_Real_r_PORTB_CLK;
  wire [31:0]hls_inst_Real_r_PORTB_DIN;
  wire [31:0]hls_inst_Real_r_PORTB_DOUT;
  wire hls_inst_Real_r_PORTB_EN;
  wire hls_inst_Real_r_PORTB_RST;
  wire [3:0]hls_inst_Real_r_PORTB_WE;
  ...
  assign Imag_PORTB_addr[31:0] = hls_inst_Imag_PORTB_ADDR;
  assign Imag_PORTB_clk = hls_inst_Imag_PORTB_CLK;
  assign Imag_PORTB_din[31:0] = hls_inst_Imag_PORTB_DIN;
  assign Imag_PORTB_en = hls_inst_Imag_PORTB_EN;
  assign Imag_PORTB_rst = hls_inst_Imag_PORTB_RST;
  assign Imag_PORTB_we[3:0] = hls_inst_Imag_PORTB_WE;
  ...
  assign Real_r_PORTB_addr[31:0] = hls_inst_Real_r_PORTB_ADDR;
  assign Real_r_PORTB_clk = hls_inst_Real_r_PORTB_CLK;
  assign Real_r_PORTB_din[31:0] = hls_inst_Real_r_PORTB_DIN;
  assign Real_r_PORTB_en = hls_inst_Real_r_PORTB_EN;
  assign Real_r_PORTB_rst = hls_inst_Real_r_PORTB_RST;
  assign Real_r_PORTB_we[3:0] = hls_inst_Real_r_PORTB_WE;
  assign ap_clk_0_1 = ap_clk;
  assign ap_rst_n_0_1 = ap_rst_n;
  assign hls_inst_Imag_PORTA_DOUT = Imag_PORTA_dout[31:0];
  assign hls_inst_Imag_PORTB_DOUT = Imag_PORTB_dout[31:0];
  assign hls_inst_Real_r_PORTA_DOUT = Real_r_PORTA_dout[31:0];
  assign hls_inst_Real_r_PORTB_DOUT = Real_r_PORTB_dout[31:0];
  ...
  bd_0_hls_inst_0 hls_inst
       (.Imag_Addr_A(hls_inst_Imag_PORTA_ADDR),
        .Imag_Addr_B(hls_inst_Imag_PORTB_ADDR),
        .Imag_Clk_A(hls_inst_Imag_PORTA_CLK),
        .Imag_Clk_B(hls_inst_Imag_PORTB_CLK),
        .Imag_Din_A(hls_inst_Imag_PORTA_DIN),
        .Imag_Din_B(hls_inst_Imag_PORTB_DIN),
        .Imag_Dout_A(hls_inst_Imag_PORTA_DOUT),
        .Imag_Dout_B(hls_inst_Imag_PORTB_DOUT),
        .Imag_EN_A(hls_inst_Imag_PORTA_EN),
        .Imag_EN_B(hls_inst_Imag_PORTB_EN),
        .Imag_Rst_A(hls_inst_Imag_PORTA_RST),
        .Imag_Rst_B(hls_inst_Imag_PORTB_RST),
        .Imag_WEN_A(hls_inst_Imag_PORTA_WE),
        .Imag_WEN_B(hls_inst_Imag_PORTB_WE),
        .Real_r_Addr_A(hls_inst_Real_r_PORTA_ADDR),
        .Real_r_Addr_B(hls_inst_Real_r_PORTB_ADDR),
        .Real_r_Clk_A(hls_inst_Real_r_PORTA_CLK),
        .Real_r_Clk_B(hls_inst_Real_r_PORTB_CLK),
        .Real_r_Din_A(hls_inst_Real_r_PORTA_DIN),
        .Real_r_Din_B(hls_inst_Real_r_PORTB_DIN),
        .Real_r_Dout_A(hls_inst_Real_r_PORTA_DOUT),
        .Real_r_Dout_B(hls_inst_Real_r_PORTB_DOUT),
        .Real_r_EN_A(hls_inst_Real_r_PORTA_EN),
        .Real_r_EN_B(hls_inst_Real_r_PORTB_EN),
        .Real_r_Rst_A(hls_inst_Real_r_PORTA_RST),
        .Real_r_Rst_B(hls_inst_Real_r_PORTB_RST),
        .Real_r_WEN_A(hls_inst_Real_r_PORTA_WE),
        .Real_r_WEN_B(hls_inst_Real_r_PORTB_WE),
        .ap_clk(ap_clk_0_1),
