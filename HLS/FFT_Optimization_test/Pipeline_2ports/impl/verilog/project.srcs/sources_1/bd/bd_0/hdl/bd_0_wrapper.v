...
module bd_0_wrapper
  ...
  output [31:0]Imag_PORTB_addr;
  output Imag_PORTB_clk;
  output [31:0]Imag_PORTB_din;
  input [31:0]Imag_PORTB_dout;
  output Imag_PORTB_en;
  output Imag_PORTB_rst;
  output [3:0]Imag_PORTB_we;
  ...
  output [31:0]Real_r_PORTB_addr;
  output Real_r_PORTB_clk;
  output [31:0]Real_r_PORTB_din;
  input [31:0]Real_r_PORTB_dout;
  output Real_r_PORTB_en;
  output Real_r_PORTB_rst;
  output [3:0]Real_r_PORTB_we;
  input ap_clk;
  input ap_rst_n;
  output interrupt;
  ...
  wire [31:0]Imag_PORTB_addr;
  wire Imag_PORTB_clk;
  wire [31:0]Imag_PORTB_din;
  wire [31:0]Imag_PORTB_dout;
  wire Imag_PORTB_en;
  wire Imag_PORTB_rst;
  wire [3:0]Imag_PORTB_we;
  ...
  wire [31:0]Real_r_PORTB_addr;
  wire Real_r_PORTB_clk;
  wire [31:0]Real_r_PORTB_din;
  wire [31:0]Real_r_PORTB_dout;
  wire Real_r_PORTB_en;
  wire Real_r_PORTB_rst;
  wire [3:0]Real_r_PORTB_we;
  wire ap_clk;
  wire ap_rst_n;
  wire interrupt;
  ...
  bd_0 bd_0_i
       (.Imag_PORTA_addr(Imag_PORTA_addr),
        ...
        .Imag_PORTB_addr(Imag_PORTB_addr),
        .Imag_PORTB_clk(Imag_PORTB_clk),
        .Imag_PORTB_din(Imag_PORTB_din),
        .Imag_PORTB_dout(Imag_PORTB_dout),
        .Imag_PORTB_en(Imag_PORTB_en),
        .Imag_PORTB_rst(Imag_PORTB_rst),
        .Imag_PORTB_we(Imag_PORTB_we),
        ...
        .Real_r_PORTB_addr(Real_r_PORTB_addr),
        .Real_r_PORTB_clk(Real_r_PORTB_clk),
        .Real_r_PORTB_din(Real_r_PORTB_din),
        .Real_r_PORTB_dout(Real_r_PORTB_dout),
        .Real_r_PORTB_en(Real_r_PORTB_en),
        .Real_r_PORTB_rst(Real_r_PORTB_rst),
        .Real_r_PORTB_we(Real_r_PORTB_we),
        .ap_clk(ap_clk),
        .ap_rst_n(ap_rst_n),
        .interrupt(interrupt),
