...
################################################################
# This is a generated script based on design: FFT_Reorder_x_num
#
...
# source FFT_Reorder_x_num_script.tcl
...
set design_name FFT_Reorder_x_num
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set Imag_0_address0_0 [ create_bd_port -dir O -from 11 -to 0 -type data Imag_0_address0_0 ]
  ...
  set Imag_1_address0_0 [ create_bd_port -dir O -from 11 -to 0 -type data Imag_1_address0_0 ]
  ...
  set Imag_2_address0_0 [ create_bd_port -dir O -from 11 -to 0 -type data Imag_2_address0_0 ]
  ...
  set Imag_3_address0_0 [ create_bd_port -dir O -from 11 -to 0 -type data Imag_3_address0_0 ]
  ...
  set Real_0_address0_0 [ create_bd_port -dir O -from 11 -to 0 -type data Real_0_address0_0 ]
  ...
  set Real_1_address0_0 [ create_bd_port -dir O -from 11 -to 0 -type data Real_1_address0_0 ]
  ...
  set Real_2_address0_0 [ create_bd_port -dir O -from 11 -to 0 -type data Real_2_address0_0 ]
  ...
  set Real_3_address0_0 [ create_bd_port -dir O -from 11 -to 0 -type data Real_3_address0_0 ]
  ...
  set num_word_0 [ create_bd_port -dir I -from 31 -to 0 -type data num_word_0 ]
  set_property -dict [ list \
  ...
  connect_bd_net -net num_word_0_1 [get_bd_ports num_word_0] [get_bd_pins Reorder_fft_0/num_word]
